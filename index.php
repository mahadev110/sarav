...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light fixed-top shadow py-lg-0 px-4 px-lg-5 wow fadeIn"
        ...
        <a href="index.html" class="navbar-brand d-block d-lg-none">
            <h1 class="text-primary fw-bold m-0">Sarav Jagadeesan</h1>
        </a>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 py-6 pb-0 pt-lg-0">
                    ...
                    <h1 class="display-3 mb-3">Sarav Jagadeesan</h1>
                    <h2 class="typed-text-output d-inline"></h2>
                    <div class="typed-text d-none">Director of Cloud platform, Infrastructure & MLOPS</div>
    ...
    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
        <div class="service-item d-flex flex-column flex-sm-row bg-white rounded h-100 p-4 p-lg-5">
            ...
            <div class="ms-sm-4">
                ...
                <span>Design, deploy, and manage cloud-based solutions to enhance performance, security, and efficiency.</span>
            </div>
        </div>
    </div>
    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
        <div class="service-item d-flex flex-column flex-sm-row bg-white rounded h-100 p-4 p-lg-5">
            ...
            <div class="ms-sm-4">
                ...
                <span>Automate workflows, CI/CD pipelines, and infrastructure management for agile software deployment.</span>
            </div>
        </div>
    </div>
    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
        <div class="service-item d-flex flex-column flex-sm-row bg-white rounded h-100 p-4 p-lg-5">
            ...
            <div class="ms-sm-4">
                ...
                <span>Implement robust security frameworks to safeguard data, networks, and applications from threats.</span>
            </div>
        </div>
    </div>
    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
        <div class="service-item d-flex flex-column flex-sm-row bg-white rounded h-100 p-4 p-lg-5">
            ...
            <div class="ms-sm-4">
                ...
                <span>Optimize IT infrastructure with proactive monitoring, automation, and maintenance strategies.</span>
            </div>
        </div>
    </div>
</div>
